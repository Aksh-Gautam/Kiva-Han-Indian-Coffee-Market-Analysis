...
st.set_page_config(
    page_title="Kiva Han | Indian Coffee Market",
    page_icon="☕",
    layout="wide",
    ...
    st.markdown(
        ...
        <div class="brand">
            <div class="brand-row">
                ...
                <div>
                    <div class="brand-title">KIVA HAN</div>
...
st.markdown('<div class="footer">KIVA HAN • Indian Coffee Market Intelligence • Earthy Minimal UI</div>', unsafe_allow_html=True)
