...
[![Quality Check](https://github.com/Aksh-Gautam/Kiva-Han-Indian-Coffee-Market-Analysis/actions/workflows/quality.yml/badge.svg)](https://github.com/Aksh-Gautam/Kiva-Han-Indian-Coffee-Market-Analysis/actions/workflows/quality.yml)
...
Kiva Han is an end-to-end analytics project built to understand **coffee consumer behaviour in India** from survey data.
...
```text
Kiva Han-Indian-Coffee-Market-Intelligence/
├── README.md
├── LICENSE
├── .gitignore
├── requirements.txt
├── notebooks/
│   └── Kiva Han_Analysis.ipynb
├── dashboard/
│   ├── app.py
│   ├── README.md
...
```text
notebooks/Kiva Han_Analysis.ipynb
```
